...
// =============================================================================
// openmp.hpp - OpenMP Backend Implementation
// =============================================================================
...
namespace lz {
   ...
   namespace internal {
      ...
      // -------------------------------------------------------------------------
      // OpenMP-specific parallel implementations (defined in openmp.cpp)
      // -------------------------------------------------------------------------
   ...
   namespace utils {
      ...
      // -------------------------------------------------------------------------
      // OpenMP-specific utility functions (defined in openmp.cpp)
      // -------------------------------------------------------------------------
