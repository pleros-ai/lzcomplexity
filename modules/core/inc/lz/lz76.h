...
namespace lz {
   ...
   namespace lz76 {
      ...
      public:
         LempelZiv76() :factorization(0) {};          //!> default constructor.
      ...
      inline LempelZiv76::LempelZiv76(const LempelZiv76& lz) :
         factorization(lz.factorization),
         lzf(lz.lzf) {}
      ...
      /// @param lz the source
      /// @return *this
      inline constexpr bool operator==(const LempelZiv76& lhs, const LempelZiv76& rhs) {
