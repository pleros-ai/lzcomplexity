...
namespace lz {
  namespace utils {
    ...
    struct LZ_Args : public SA_Args {
      ...
      lz_uint alphabet = details::NO_ALPHABET;  ///< Alphabet size for entropy normalization.
      lz_uint log_base = details::NO_ALPHABET;  ///< Logarithm base for entropy computation.
      ...
      friend bool operator==(LZ_Args sa1, LZ_Args sa2) {
        return sa1.chunks == sa2.chunks && sa1.max_context == sa2.max_context
          && sa1.block_size == sa2.block_size && sa1.get_shuffle_terms == sa2.get_shuffle_terms
          && sa1.alphabet == sa2.alphabet;
      };
  ...
  public:
       ...
       */
      friend bool operator==(const LempelZiv& lhs, const LempelZiv& rhs) {
