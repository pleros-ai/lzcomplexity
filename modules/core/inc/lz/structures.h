...
namespace lz {
   namespace utils {
     ...
     protected:
         ...
         LZ_Shuffle random_shuffle_complexity;  //!> excess of entropy by shuffling of the sequence
         LZ_Shuffle paired_shuffle_complexity;  //!> excess of entropy by shuffling
