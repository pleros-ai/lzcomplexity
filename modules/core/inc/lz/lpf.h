...
namespace lz {
  ...
  public:
    ...
    inline lz_uint LPFStack::TopLen(void) const { return element.back().len; }

    inline lz_uint LPFStack::TopPos(void) const { return element.back().pos; }
    ...
    inline lz_bool LPFStack::empty(void) const { return element.empty(); }
