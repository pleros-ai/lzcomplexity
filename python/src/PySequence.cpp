...
void PySequence(py::module& m) {
   ...
   sequence.def(py::init())
       ...
       .def("Min", py::overload_cast<lz::sequence&, lz::lz_size, lz::lz_size>(&::Min), "Min character between a range",
            "start"_a, "final"_a)
       .def("Max", py::overload_cast<lz::sequence&>(&::Max), "Max character of the sequence")
       .def("Max", py::overload_cast<lz::sequence&, lz::lz_size, lz::lz_size>(&::Max), "Max character between a range",
            "start"_a, "final"_a)
   ...
   m.def("Shuffle", py::overload_cast<const lz::sequence&, lz::lz_uint, lz::lz_uint>(&lz::Shuffle), "seq"_a,
         "block_size"_a, "times"_a);
}