...
void PyStructures(py::module& m) {
   ...
   LZ_Shuffle.def(py::init())
      .def(py::init<lz::lz_int, lz::lz_double, lz::lz_double>(),
           "max_block_size_"_a,
           "excess_value_"_a,
   ...
   // Define attributes
   LZ_Shuffle
      .def_readwrite("max_block_size", &utl::LZ_Shuffle::max_block_size, "Max block size for shuffle entropy deficit.")
   ...
   LZ_Args
      ...
      .def_readwrite(
         "log_base", &utl::LZ_Args::log_base, "Alphabet base (most of the time is the same as the alphabet size)")
